...
class LoginTest(myunit.MyTest):
    ...
    def test_login_success(self):
        ...
        try:
            ...
            mylog = log()
            mylog.setMSG('info', '0.什么都不输入，点击提交按钮，看提示信息。（非空检查）')
    ...
    """        
    def test_0No_user_and_pwd_failure(self):
        '''什么都不输入，点击提交按钮'''
        ...
        mylog = log()
        mylog.error('0.什么都不输入，点击提交按钮，看提示信息。（非空检查）')
    ...
    def test_8_1_username_before_space(self):
        ...
        print('\n' + username + '登录成功')                               # 打印信息
        # function.insert_img(self.driver, "before_space.png")
    ...
    def test_8_3_password_before_space(self):
        ...
        # function.insert_img(self.driver, "password_before_space.png")
    ...
    def test_8_4_password_after_space(self):
        ...
        self.assertEqual(po.pppiglogin_erro_hint(), '密码错误!')           # 断言用户登录到系统
        print('\n' + po.pppiglogin_erro_hint())                               # 打印信息
        # function.insert_img(self.driver, "password_after_space.png")
