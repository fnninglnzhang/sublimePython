...
class LoginTest(myunit.MyTest):
    ...
    def test_login_user_pwd_null(self):
        ...
        po.login_action('', '')
        # sleep(2)
        # po.wait_title_contains("请输入账号")
        # po.wait_presence_of_element_located("请输入账号")
        po.wait_presence_of_element_login_error_hint_located("请输入账号")
    ...
    def test_login_user_pwd_error(self):
        ...
        po.wait_presence_of_element_located("1")
